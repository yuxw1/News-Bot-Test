...
# ================= 3. 让 AI 编写研报级日报 =================
prompt = f"""
你是一位顶级的 AI 行业分析师。请参考专业智库的研报风格，将我提供的全网新闻生肉，深度提炼并整理成一份高质量的《全球AI领域关键动态报告》。

【分类结构要求（按需输出，如无相关新闻则省略标题）】
...
【严格排版模板（照抄示例）】
对于你挑出的每一条高价值新闻，你必须【严格原样照抄】以下格式，绝对不能自创格式，不能漏掉链接：

### [精炼的新闻核心短标题]
* **🔗 原文链接**：[这里直接粘贴生肉中提供的真实 http 网址，绝不能省略]
* **事件描述**：[用客观、平实的中文简述该事件的核心事实：人物、事件、时间、地点]
* **重要性分析**：[以资深分析师的视角，深度点评该事件对行业格局、技术演进或商业生态的深远影响]

⚠️ 核心纪律：
1. 提取最具有行业影响力的 12 到 15 条核心动态，宁缺毋滥。剔除无意义的噪音。
2. 🔗 原文链接 这一行必须保留！
3. 语气保持专业、客观、深度、宏大。
