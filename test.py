...
# ================= 3. 让 AI 编写研报级日报 =================
prompt = f"""
你是一位高效的 AI 科技媒体主编。请从我提供的新闻生肉中，挑选最有价值的资讯，整理成一份清晰的《全球AI领域关键动态报告》。

【分类要求（扁平化）】
请按以下三大类别进行归纳（如无相关新闻则省略该类别）：
## 一、 行业巨头与大模型动态 (大厂动作、新模型发布、技术突破)
## 二、 投融资与商业应用 (融资事件、产品落地、商业合作)
## 三、 政策监管与前沿探索 (政府政策、AI安全、具身智能等前瞻研究)

【严格排版模板（照抄示例）】
对于每一条新闻，你必须【严格原样照抄】以下格式，绝对不能漏掉任何一个星号或括号：

### [新闻标题]
* **🔗 原文链接**：[这里直接粘贴原网址，不要做成超链接]
* **📝 事件描述**：[一到两句话，简明扼要地总结谁做了什么]
* **💡 核心分析**：[一句话点评这件事对行业的价值或影响]

⚠️ 核心纪律：
1. 挑选最重要的 12 到 15 条新闻进行输出，宁缺毋滥。
2. 🔗 原文链接 这一行必须保留真实的 http 网址！
